...
/**
 * This method tracks where the user currently is in the tour. It interacts heavily with the 
 * command methods and is crucial. It also holds the backpack arraylist which stores users items.
 * @author Luke Busch “I hereby declare upon my word of honor that I have
